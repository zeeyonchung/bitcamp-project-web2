...
public class StudentDetailServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response) 
    ...
    try {
      ...
      out.printf("<tr><th>회원일련번호</th><td>"
          + "<input name='memberNo' type='number' value='%s' readonly></td></tr>\n",
                student.getMemberNo());
      ...
      out.printf("<tr><th>최종학력</th><td>"
          + "<input name='grade' type='text' value='%s'></td></tr>\n", 
          student.getGrade());
      out.printf("<tr><th>학교</th><td>"
          + "<input name='schoolName' type='text' value='%s'></td></tr>\n", 
          student.getSchoolName());
      out.printf("<tr><th>상세주소</th><td>"
          + "<input name='detailAddress' type='text' value='%s'></td></tr>\n", 
          student.getDetailAddress());
      out.println("</table>");
      
      out.println("<button type='submit'>변경</button>");
      out.printf(" <a href='delete?memberNo=%d'>삭제</a>", student.getMemberNo());
